package com.pms.pmsproj.Controller.BuildingExecController;
...
public class BuildingLoginController {
    @FXML
    ...
    public void checkUserLogin(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(HelloApplication.class.getResource("buildingExec-view.fxml"));
